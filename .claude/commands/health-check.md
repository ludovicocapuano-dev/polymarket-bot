---
description: Health check rapido del bot - stato processo, errori recenti, posizioni, scanning attivo
allowed-tools: [Read, Grep, Bash]
---

# Health Check

Esegui un controllo rapido dello stato del bot.
...
```
Se log piu' vecchio di 10 min: WARNING.

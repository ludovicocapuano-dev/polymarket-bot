...
WEATHER_CITIES: dict[str, dict] = {
    ...
    # v13.3: 13 nuove città trovate su Polymarket (5 Apr 2026)
    "hong kong": {
        "lat": 22.308,
        "lon": 113.918,
        "keywords": ["hong kong"],
        "station": "Hong Kong Intl",
        "wethr_code": "VHHH",
        "nws_grid": None,
        "unit": "C",
    },
